<template>
  <div>
    <el-button type="primary" @click="addFormVisible=true">查看无申请离校学生</el-button>
    <el-dialog title="查看无申请离校超时学生" :visible.sync="addFormVisible">
...
export default {
  ...
  methods: {
    getLeftStudent() {
      this.$axios
        .get("/admin/student/leave/no-request/")
        .then(response => {
