<template>
  <div>
    <el-button type="primary" @click="addFormVisible = true">查看出校申请</el-button>
    <el-dialog title="查看出校申请" :visible.sync="addFormVisible">
      <el-table
        ref="filterTable"
...
export default {
  ...
  methods: {
    ...
    getEnterReportList () {
      ...
      let url = '/admin/request/leave/class/' + jsonObj.user.classId
      this.$axios
        .get(url)
        .then(res => {
          if (res.data.code === 0) {
